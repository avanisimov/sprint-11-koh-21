package ru.yandex.practicum.sprint11koh21
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val retrofit = Retrofit.Builder()
            .baseUrl("https://raw.githubusercontent.com/avanisimov/sprint-11-koh-21/")
            .addConverterFactory(
...
// https://raw.githubusercontent.com/avanisimov/sprint-11-koh-21/main/jsons/news_1.json
